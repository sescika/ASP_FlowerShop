        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupplierPhone = table.Column<string>(type: "nvarchar(75)", maxLength: 75, nullable: false),
                    SupplierAddress = table.Column<string>(type: "nvarchar(75)", maxLength: 75, nullable: true),
                    SupplierCity = table.Column<string>(type: "nvarchar(75)", maxLength: 75, nullable: true),
                    SupplierState = table.Column<string>(type: "nvarchar(75)", maxLength: 75, nullable: true),
                    SupplierZipCode = table.Column<string>(type: "nvarchar(12)", maxLength: 12, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UseCases", x => x.Name);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentMethod = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "mastercard"),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UseCasesName = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerUseCase", x => new { x.CustomersId, x.UseCasesName });
                    table.ForeignKey(
                        name: "FK_CustomerUseCase_Customers_CustomersId",
                        column: x => x.CustomersId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerUseCase_UseCases_UseCasesName",
                        column: x => x.UseCasesName,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UseCaseLogs_UseCases_UseCaseName",
                        column: x => x.UseCaseName,
                        principalTable: "UseCases",
                        principalColumn: "Name",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryAddress = table.Column<string>(type: "nvarchar(75)", maxLength: 75, nullable: false),
                    DeliveryCity = table.Column<string>(type: "nvarchar(75)", maxLength: 75, nullable: false),
                    DeliveryState = table.Column<string>(type: "nvarchar(75)", maxLength: 75, nullable: false),
                    DeliveryZipCode = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DeliveryStatus = table.Column<string>(type: "nvarchar(75)", maxLength: 75, nullable: false, defaultValue: "pending"),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true)
                },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customers_Name_LastName_Email_Username",
                table: "Customers",
                columns: new[] { "Name", "LastName", "Email", "Username" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerUseCase_UseCasesName",
                table: "CustomerUseCase",
                column: "UseCasesName");
